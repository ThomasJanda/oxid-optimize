...
$aLang = array(
    ...
    'SHOP_MODULE_rs-optimize_group_css'      => 'If you like to combine CSS files use follwing schema #GROUP_NAME#|#ABSOLUTE_PATH_FROM_SHOP_ROOT# (e.g. main|modules/rs/navigationbar/out/src/css/rs-megamenu.scss). All files with the same group name will combine to one file and safe in the out folder. The file will add to the top of the list of css files. For each view of the shop, the file will recreate.',
